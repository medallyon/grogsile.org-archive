...
class WikiEmbed extends Discord.MessageEmbed
{
    constructor($, data = [])
    {
        ...
        super.setFooter(`${dClient.constants.discord.embed.footer.text} | ${dClient.modules.utils.fancyESODate()} ${dClient.libs.dateFormat("HH:MM")} UTC`, dClient.constants.discord.embed.footer.icon_url);
