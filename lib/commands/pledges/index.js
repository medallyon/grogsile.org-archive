...
function pledges(msg)
{
    fetchCurrentPledges()
        .then(function(currentPledges)
        {
            ...
            return msg.channel.send({ embed: createEmbed(requestedPledges) }).catch(dClient.modules.utils.consoleError);
...
module.exports.name = "pledges";
module.exports.about = "Displays today's pledges.";
...
module.exports.arguments = {
    "Quest Giver": {
        description: "Displays the pledge for this Quest Giver.",
        optional: true
    }
};
module.exports.userPermissions = 100;
module.exports.example = "[ Maj | Glirion | Urgalarg ]";
module.exports.function = pledges;
