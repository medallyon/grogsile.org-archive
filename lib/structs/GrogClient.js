...
class GrogClient extends Discord.Client
{
    ...
    constructor(options = {})
    {
        ...
        // since utils are imported after constants, some constants need to be changed
        this.constants.discord.embed.color = this.modules.utils.randColor();
        this.constants.web.session.secret = this.modules.utils.genSecret();
